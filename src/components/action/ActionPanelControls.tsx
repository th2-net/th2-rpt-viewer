...
const ActionPanelControlBase = observer(() => {
	const { selectedStore } = useStores();
	return selectedStore.isCheckpointsEnabled ? (
		<div className="layout-control">
			<div className="layout-control__icon cp"
				onClick={() => {
					if (selectedStore.currentCheckpoint) {
						selectedStore.selectCheckpointAction(selectedStore.currentCheckpoint);
					}
				}}
...
export default ActionPanelControlBase;

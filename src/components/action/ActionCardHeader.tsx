...
import { ActionMlUploadButtonBase } from '../ActionMlUploadButton';
...
export default function ActionCardHeader({
	action, toggleExpand, panelArea, isSelected, isTransparent, isExpanded,
}: Props) {
	const {
		id,
		matrixId,
	...
	return (
		<div className={headerClassName}>
			...
			<div className="ac-header__controls">
				...
				<ActionMlUploadButtonBase actionId={action.id}/>
			</div>
		</div>
	);
}

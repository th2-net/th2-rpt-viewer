...
const JSONViewerWorkspace = () => {
	...
	const defaultPanel = React.useMemo(
		() =>
			computed(() => ({
				...
				component: <JSONPanel type={'default'} />,
				isActive: true,
			})),
		[
	...
	const comparePanel = React.useMemo(
		() =>
			computed(() => ({
				...
				component: <JSONPanel type={'compare'} />,
				isActive: true,
			})),
		[
	...
	const viewerWorkspacePanels = React.useMemo(
		() => [defaultPanel, JSONViewerStore.isCompare ? comparePanel : tablePanel],
		[defaultPanel, comparePanel, tablePanel, JSONViewerStore.isCompare],
	);

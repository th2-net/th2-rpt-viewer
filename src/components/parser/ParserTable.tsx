...
const ParserTable = ({ rows }: { rows: [string, string | string[] | Tree | undefined][] }) => (
...
const TableRows = ({ rows }: { rows: [string, string | string[] | Tree | undefined][] }) => (
	<>
		{rows.map(([key, value]) =>
...
const ExpandRow = ({
	...
	parentKey: string;
	rows: [string, string | string[] | Tree | undefined][];
}) => {

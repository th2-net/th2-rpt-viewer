...
export function KnownBugCard({
	bug, actionsMap, isSelected, onSelect, selectedStatus,
}: KnownBugCardProps) {
	...
	const relatedActions = React.useMemo(() => bug.relatedActionIds.reduce((actions, id) =>
		(actionsMap.has(id) ? [...actions, actionsMap.get(id) as Action] : actions), [] as Action[]), [actionsMap]);
		...
		<div className={rootClassName}
			...
			<div className="known-bug-card__left">
				<ChipsList
					...
					selectedStatus={isSelected ? selectedStatus : null}/>
			</div>

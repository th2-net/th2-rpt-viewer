...
} from '../message/message-card/MessageCardViewTypeRenderer';
import MessageCardTools, { MessageCardToolsConfig } from '../message/message-card/MessageCardTools';
...
export function EmbeddedMessageCardBase({
	message,
	viewType,
	setViewType,
	hoverMessage,

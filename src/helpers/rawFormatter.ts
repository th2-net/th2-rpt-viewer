 ...
 * @param rawBase64Content raw base64 encoded content
 * @return {string[][]} firts item - offset, second item - hexadecimal representation,
 * third item - human-readable group.
 */
export function decodeBase64RawContent(rawBase64Content: string): string[][] {
	...
	while (index < length) {
		let offsetColumn = '';
		let hexadecimalColumn = '';
		let humanReadableColumn = '';

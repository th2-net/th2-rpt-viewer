...
interface UseParentEventsState {
	selectedParentEvent: EventAction | null;
	setSelectedNode: (node: EventTreeNode | null) => void;
	parentEvents: Map<string, EventAction>;
